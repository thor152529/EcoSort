    ...
    <div className="relative h-full bg-background pb-24">
      <div className="bg-gradient-hero text-primary-foreground rounded-b-[2rem] pb-8 relative overflow-hidden">
        ...
        <div className="relative flex items-center justify-between px-6 pt-2">
          ...
          <div className="text-center"><p className="text-[8px] uppercase tracking-[0.18em] opacity-60">Presentation Preview</p><p className="text-sm font-medium opacity-90">AI Detection</p></div>
      ...
      <div className="px-5 -mt-6 space-y-3">
        ...
        <div className="grid grid-cols-2 gap-2">
          <div className="bg-secondary/70 rounded-2xl p-3 border border-border"><CircleCheck className="h-4 w-4 text-primary" /><p className="text-lg font-bold font-display mt-1">98.4%</p><p className="text-[9px] text-muted-foreground">Demo confidence</p></div>
